...
# PostgreSQL 15 to 16 Rescue Migration Script for Blipyy
...
BACKUP_FILE="blipyy_backup_${TIMESTAMP}.sql"

echo -e "${BLUE}=== Blipyy PostgreSQL 15 to 16 Rescue Migration ===${NC}"
